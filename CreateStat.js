...
function refreshMotif(mot1,mot2,gare1,gare2){
	...
	if(sum1==0 || sum2==0){
		...
		motifSvg.append("text")
			.text("Données manquantées :-("+ chiffre)
			.attr("x",0)
			.attr("y",30)
			.attr("font-size",10)
	...
	var x_motif = d3.scaleBand()
		.domain(['Journaliers','Etudes','Business','Loisir'])
  ...
  y_motif.domain([0,max_motif])
	...
	motifG.append("rect")
  					 .attr("x", x_motif('les journaliers')+x_motif1(1)-20)
  ...
  motifG.append("rect")
  					 .attr("x", x_motif('les journaliers')+x_motif1(1))
